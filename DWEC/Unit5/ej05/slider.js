...
export default class Slider {
     ...
     */
    constructor(sliderClass, autoPlayDelay = 2000) {
        // Check if the autoplay delay is a number or not
        if (isNaN(autoPlayDelay)) {
            throw Error("The auto play delay must be a number")
        }
        ...
        this.setSlidesContainerWidth(window.innerWidth);
        this.setSlidesWidth(window.innerWidth);
    ...
    passSlideToRight() {
        ...
        let translatePixel = window.innerWidth;
        ...
        const maxTranslateWidth = (this.#slides.length-1) * window.innerWidth;
