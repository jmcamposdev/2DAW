...
!function(e) {
    ...
    var a = "undefined" != typeof window ? window : this,
        e = a.Glider = function(e, t) {
            ...
            }, t), o.animate_id = o.page = o.slide = 0, o.arrows = {}, o._opt = o.opt, o.opt.skipTrack)
    ...
    return t.init = function(e, t) {
        ...
        d.opt.rewind || (d.arrows.prev && d.arrows.prev.classList.toggle("disabled", d.ele.scrollLeft <= 0 || t), d.arrows.next && d.arrows.next.classList.toggle("disabled", Math.ceil(d.ele.scrollLeft + d.containerWidth) >= Math.floor(d.trackWidth) || t)),
        ...
        d.ele.scrollLeft + d.containerWidth >= Math.floor(d.trackWidth) && (d.page = d.dots ? d.dots.children.length - 1 : 0),
            [].forEach.call(d.slides, function(e, t) {
                ...
                [].forEach.call(o, function(e) {
                    ...
                    c === t || h && h === t ? o.add("center") : (o.remove("center"), o.add([t < c ? "left" : "right", Math.abs(t - (t < c ? c : h || c))].join("-")));
                var a = Math.ceil(l) >= r && Math.floor(n) <= s;
                o.toggle("visible", a),
                a !== i && d.emit("slide-" + (a ? "visible" : "hidden"), {
                    slide: t
                })
            }),
        ...
        e && d.opt.scrollLock && (clearTimeout(d.scrollLock), d.scrollLock = setTimeout(function() {
            ...
            .02 < Math.abs(d.ele.scrollLeft / d.itemWidth - d.slide) && (d.mouseDown || d.scrollItem(d.round(d.ele.scrollLeft / d.itemWidth)))
        ...
        var r = this,
            ...
            n = function() {
                ...
                r.ele.scrollLeft = r.ele.scrollLeft + (t - r.ele.scrollLeft) * r.opt.easing(0, e, 0, 1, o),
                    e < o && l === r.animate_id ? a.requestAnimationFrame(n) : (r.ele.scrollLeft = t, i && i.call(r))
            };
