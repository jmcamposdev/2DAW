...
<?php $component->withAttributes([]); ?>
                            ...
                            <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <form class="inline-block" action="<?php echo e(route('books.destroy', $book->id)); ?>"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#booksTable_filter label input').addClass('border rounded-md p-2 focus:outline-none focus:border-indigo-500');
    
            // Optionally, you can style the DataTables default pagination
            $('#booksTable_paginate ul.pagination').addClass('flex space-x-2');
            $('#booksTable_paginate ul.pagination li').addClass('px-2 py-1 border rounded-md');
    
            // Add a search bar label for better accessibility
            $('#booksTable_filter label').addClass('flex items-center');
    
            // Optionally, you can style other DataTables elements as needed
            // $('#booksTable_info, #booksTable_length').addClass('text-sm text-gray-500');
        });
    </script>
...
<?php endif; ?>
<?php /**PATH /www/wwwroot/servidor.jmcampos.dev/DWES/UD4/library-app/resources/views/books/index.blade.php ENDPATH**/ ?>